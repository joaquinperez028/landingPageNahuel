  ...
  const defaultAlertExamples: AlertExample[] = [
    {
      ...
      description: 'Señal de venta total en EDN con excelente rendimiento',
    ...
    {
      id: '2',
      title: 'Alerta SPOT - Venta Parcial',
    ...
    },
    {
      ...
      description: 'Señal de compra confirmada con análisis técnico',
