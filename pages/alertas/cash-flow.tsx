                      ...
                      .map((image: any, index: number) => (
                        <div key={index} className={styles.reportImage}>
                          <img 
                            ...
                            onError={(e) => {
                              console.error('Error cargando imagen adicional:', image.url || image.secure_url);
                              const target = e.currentTarget;
                              target.style.display = 'none';
                            }}
                          />
  ...
  return (
    <div className={styles.modalOverlay} onClick={onClose}>
      <div className={styles.createReportModal} onClick={(e) => e.stopPropagation()}>
        <div className={styles.modalHeader}>
          <h2>Crear Nuevo Informe Cash Flow</h2>
          <button 
            className={styles.closeModal}
            onClick={onClose}
            disabled={loading}
        ...
        <form onSubmit={handleSubmit} className={styles.createReportForm}>
          <div className={styles.formGroup}>
            ...
            <input
              ...
              placeholder="Título del informe Cash Flow"
              required
              disabled={loading}
            />
          </div>
          ...
          <div className={styles.formGroup}>
            ...
            <textarea
              ...
              placeholder="Breve descripción del análisis Cash Flow"
              rows={3}
              disabled={loading}
            />
          </div>
          ...
          <div className={styles.formGroup}>
            ...
            <textarea
              ...
              placeholder="Contenido completo del análisis Cash Flow"
              rows={8}
              required
              disabled={loading}
            />
          ...
          <div className={styles.formGroup}>
            ...
            <input
              ...
              placeholder="cash-flow, flujos, opciones"
              disabled={loading}
            />
          </div>
